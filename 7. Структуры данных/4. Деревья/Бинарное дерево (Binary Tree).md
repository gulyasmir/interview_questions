...
* **Полное** – все уровни (кроме последнего) заполнены.
* **Сбалансированное** – высота `O(log n)`, разница высот поддеревьев ≤ 1.
* **Выраженное** (Degenerate) – похоже на связанный список (`O(n)` операции).

---

## **2. Бинарное поисковое дерево (BST - Binary Search Tree)**
